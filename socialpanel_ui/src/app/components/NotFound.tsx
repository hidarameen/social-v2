  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="text-slate-800 mb-2" style={{ fontFamily: "Cairo, sans-serif" }}>
          الصفحة غير موجودة
        </h1>
        <p className="text-slate-500 mb-8" style={{ fontSize: "0.9375rem" }}>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <motion.button
            onClick={() => navigate(-1)}
            className="px-6 py-3 rounded-2xl bg-white text-slate-700 flex items-center gap-2"
