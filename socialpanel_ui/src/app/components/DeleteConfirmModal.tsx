      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 left-4 p-2 rounded-xl bg-slate-50 hover:bg-slate-100 transition-colors border border-slate-200"
            >
            ...
            <div className="p-6 sm:p-8 pt-12 text-center">
              ...
              <h3 className="text-slate-800 mb-2">حذف الحساب</h3>
              <p className="text-slate-500 mb-2" style={{ fontSize: "0.875rem" }}>
                هل أنت متأكد من حذف هذا الحساب؟
              </p>

              {/* Account Info */}
              <div
                className="flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-slate-50 mb-4"
              ...
              <p className="text-slate-400 mb-6" style={{ fontSize: "0.75rem" }}>
              ...
              <div className="flex gap-3">
                <motion.button
                  onClick={onClose}
                  className="flex-1 py-3 rounded-xl bg-slate-100 border border-slate-200 text-slate-600 hover:bg-slate-200 transition-colors"
